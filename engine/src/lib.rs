...
//!
//! This crate re-exports the workspace sub-crates under stable paths
//! so downstream code can `use gdsverify::*`.

pub mod env_meta;
pub mod manifest;

// Sub-crate re-exports — keeps the old `gdsverify::backend`, `gdsverify::drc`, etc. paths
...
pub use pex::{
    run_pex, run_pex_backend, run_pex_by_net, run_pex_by_net_checked, NetParasitics, Parasitic,
    PexReport,
};
