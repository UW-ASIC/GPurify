...
use crate::quasistatic::cap::solver::{accumulate_c, rhs_unit_conductor, CapResult};
use crate::quasistatic::constants::ONE_OVER_4PI_EPS0;
use crate::quasistatic::fmm::LaplaceFmm;
...
use crate::quasistatic::linalg::DenseMatrix;
...
impl FmmCapOperator {
    ...
    pub fn from_set(set: &PanelSet, order: usize, max_level: usize) -> Self {
        ...
        let pts: Vec<crate::quasistatic::geometry::Vec3> = (0..n).map(|i| set.centroid(i)).collect();
