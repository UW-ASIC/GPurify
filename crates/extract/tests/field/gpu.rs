...
use gpurify_extract::field::gpu::{Device, GpuMatVec};
use gpurify_extract::field::matvec::{select, Backend, CpuMatVec, MatVec};
use gpurify_extract::field::mesh::{build_into, Mesh, MeshOptions};
...
fn lattice(n: usize) -> Mesh {
    use gpurify_extract::field::mesh::Panel;
