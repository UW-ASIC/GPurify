...
impl SpanningForest {
    ...
    /// Deterministic: adjacency lists are filled in branch-vector order and BFS
    /// visits nodes in ascending index order, never a map iteration.
