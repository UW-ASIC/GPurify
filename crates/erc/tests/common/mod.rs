...
use gpurify_erc::ruleset::RuleHead;
use gpurify_ingest::intent::{DomainId, NetLimits, SupplyRole};
use gpurify_ingest::StrId;
use gpurify_report::{Outcome, RuleRun, Severity, Violations};
...
pub fn assert_skipped_for_intent(runs: &[RuleRun], violations: &Violations, id: StrId) {
    ...
    assert!(
        run.outcome == Outcome::Skipped(gpurify_report::SkipReason::NoDesignIntent),
