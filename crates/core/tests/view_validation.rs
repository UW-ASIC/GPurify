...
use gpurify_core::ops::{self_intersects, Winding};
use gpurify_core::view::{is_outer, validate_layer_into, ValidatedLayer, ValidityError};
use gpurify_core::{Bbox, GeometryStore, GeometryStoreBuilder, LayerId, PolyId, RingId};
