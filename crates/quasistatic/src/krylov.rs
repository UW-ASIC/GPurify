...
//!
//! Real-GMRES duplication with [`crate::solve`]: `solve::gmres` is the
//! capacitance path's solver over the [`crate::matvec::MatVec`] trait, this one
...
use crate::linalg::{axpy, caxpy, cdot_conj, dot, nrm2};
...
pub fn gmres(
    ...
    // restart cycles and Arnoldi steps, the way [`crate::solve::Workspace`]
...
mod determinism_tests {
    ...
    use super::*;
    use crate::linalg::DenseMatrix;
    use crate::operator::{BlockJacobi, BlockJacobiComplex, DenseComplexOperator, DenseOperator};
