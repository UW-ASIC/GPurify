...
//! empty clean result.
//!
//! [`Skipped`]: crate::report::Outcome::Skipped
//! [`NoDesignIntent`]: crate::report::SkipReason::NoDesignIntent

use crate::erc::facts::IntentMap;
use crate::erc::power::{effective_resistance_into, NetNetworks, Solved};
use crate::erc::ruleset::RuleHead;
use crate::erc::{centre, first_vertex, record_run, skip_rows, Design, Scratch};
...
///
/// [`check_electromigration`]: crate::erc::rules::electrical::check_electromigration
/// [`Refused`]: crate::report::Outcome::Refused
/// [`Skipped`]: crate::report::Outcome::Skipped
/// [`NoDesignIntent`]: crate::report::SkipReason::NoDesignIntent
...
impl ClampGraph {
    ...
    fn resolve(
        ...
        networks: &NetNetworks,
        intent: &IntentMap,
        solve: &mut crate::erc::power::SolveScratch,
...
/// whose node polygon centre is nearest, matching [`crate::erc::power`]. `0` for a
