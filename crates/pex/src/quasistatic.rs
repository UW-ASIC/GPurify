//! Field-solved extraction, re-exported from [`gpurify_quasistatic`].
//!
...
pub use gpurify_quasistatic::henry::bridge::{InductMatrix, InductanceError, InductanceOptions};
pub use gpurify_quasistatic::{matvec, mesh, solve, Accuracy, CapMatrix};
...
/// [`ParasiticNetwork`].
///
/// The solve itself is [`gpurify_quasistatic::extract_into`]; this wrapper adds
...
pub fn extract_into(
    ...
    let accuracy =
        gpurify_quasistatic::extract_into(store, nets, selected, stack, grid, options, matrix)?;
...
pub fn extract_inductance_into(
    ...
    gpurify_quasistatic::henry::bridge::extract_inductance_into(
