...
use crate::quasistatic::gpu::backend::{ComputeBackend, DeviceMatrix, GpuMatrixHandle, Precision};
use std::sync::Arc;
use vulkano::{
...
mod p2p_shader {
    vulkano_shaders::shader! {
        ty: "compute",
        path: "src/quasistatic/gpu/shaders/p2p.glsl",
    }
}
...
mod gemv_shader {
    vulkano_shaders::shader! {
        ty: "compute",
        path: "src/quasistatic/gpu/shaders/gemv.glsl",
    }
}
...
mod gemm_shader {
    vulkano_shaders::shader! {
        ty: "compute",
        path: "src/quasistatic/gpu/shaders/gemm.glsl",
    }
}
...
mod axpy_shader {
    vulkano_shaders::shader! {
        ty: "compute",
        path: "src/quasistatic/gpu/shaders/axpy.glsl",
    }
}
...
mod block_jacobi_shader {
    vulkano_shaders::shader! {
        ty: "compute",
        path: "src/quasistatic/gpu/shaders/block_jacobi.glsl",
    }
}
...
mod tests {
    ...
    fn vulkano_gemm_with_handle_matches_cpu() {
        use crate::quasistatic::gpu::backend::CpuBackend;
