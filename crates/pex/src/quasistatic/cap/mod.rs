...
//!
//! ```no_run
//! let geo = gdsverify_pex::quasistatic::cap::parse(&std::fs::read_to_string("bus.qui").unwrap(), 1.0).unwrap();
//! let cap = gdsverify_pex::quasistatic::cap::solve(&geo, gdsverify_pex::quasistatic::cap::Method::Direct).unwrap();
...
pub fn from_panels(
    panels: Vec<crate::quasistatic::integrals::panel::Panel>,
