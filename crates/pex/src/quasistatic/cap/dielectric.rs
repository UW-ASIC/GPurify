...
use crate::quasistatic::cap::solver::CapResult;
use crate::quasistatic::constants::{EPS0, ONE_OVER_4PI_EPS0};
use crate::quasistatic::geometry::Vec3;
use crate::quasistatic::integrals::panel::{field_integral, potential_integral, Panel};
