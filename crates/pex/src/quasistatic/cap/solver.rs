...
use crate::quasistatic::cap::geometry::Geometry;
use crate::quasistatic::constants::ONE_OVER_4PI_EPS0;
use crate::quasistatic::integrals::panel::{potential_integral, PanelSet};
use crate::quasistatic::linalg::{DenseMatrix, LuDecomposition};
use crate::quasistatic::operator::DenseOperator;
use crate::quasistatic::krylov::{gmres, GmresOptions};
...
/// BEM systems (see `crate::quasistatic::gpu::Precision`), so tol is set to 1e-4 — well
...
pub fn solve_gpu(
    ...
    use crate::quasistatic::gpu::{op::GpuDenseOp, ComputeBackend, DeviceMatrix as GpuDm};
